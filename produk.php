...
<head>
    ...
    <link rel="stylesheet" href="produk1.css">
...
<body>
    ...
    <div class="header">
        <br>
        <center><h2 id="text" style="color: white;">Data Produk</h2></center>
        <a href="tambah.php" class="btn btn-outline-light">Tambah Produk</a>
    </div><br><br>
    ...
    <div class="content">
        ...
        <tr>
            ...
            <td>
                <a href="edit.php?id_produk=<?php echo $d['id_produk'];?>"
                   class="btn btn-outline-primary">Edit</a>
                <a href="hapus.php?id_produk=<?php echo $d['id_produk'];?>"
                   class="btn btn-outline-primary">Hapus</a>
            </td>
        </tr>
        <?php 
        }
